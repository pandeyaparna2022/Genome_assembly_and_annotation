...
#setwd("C:/Users/pandapar/Desktop/Uni_courses_2022/3rd_semester/Genome_and_transcriptome_assembly/week6")
#wd1 <- Sys.getenv("OUTPUT_DIR")
output_dir <- Sys.getenv("OUTPUT_DIR")


## Import the modified output from parseRM.pl ending with "landscape.Div.Rname.tab
data <- paste0(output_dir, "/Flye_polished.fasta.mod.out.landscape.Div.Rname.tab")
dat <- fread(data)
